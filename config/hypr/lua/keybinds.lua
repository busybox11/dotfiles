...
exec("META + ALT + SHIFT + mouse:276", "playerctl position 5-", { locked = true, repeating = true })
exec("CTRL + SHIFT + mouse:276", "playerctl next", { locked = true })
exec("CTRL + SHIFT + mouse:275", "playerctl previous", { locked = true })
exec("CTRL + SHIFT + mouse:277", "playerctl play-pause", { locked = true })
...
exec(mainModShift .. " + CTRL + SPACE", "qs ipc call notifications toggleDnd")
exec(mainModShift .. " + SPACE", "qs ipc call notifications toggleCenter")
...
exec(mainMod .. " + S", "uwsm-app -s b -- spotify")
exec(mainMod .. " + D", "uwsm-app -s b -- equibop")
