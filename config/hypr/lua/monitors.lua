...
hl.monitor({ output = "desc:AOC CU34G2XP 1Q1Q7HA012666", mode = "3440x1440@180", position = "1920x0", scale = 1, bitdepth = 10 })
...
hl.monitor({ output = "desc:Xiaomi Corporation Mi monitor 5505610034644", mode = "3440x1440@100", position = "auto", scale = 1 })
hl.monitor({ output = "desc:Shenzhen KTC Technology Group H27S17 0x00000001", mode = "2560x1440@144", position = "auto", scale = 1 })
