# Generated by Powerlevel10k configuration wizard on 2025-08-07 at 06:02 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 31091. Wizard options: nerdfont-v3 + powerline, small icons, unicode, lean_8colors, 24h time,
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='󰏖 ${P9K_CONTENT}'
